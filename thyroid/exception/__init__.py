...
class ThyroidException(Exception):
    ...
    def __init__(self, error_message:Exception, error_detail:sys): 
        ...
        self.error_message = ThyroidException.get_detailed_error_message( error_message = error_message, error_detail = error_detail)
    ...
    def __repr__(self) -> str:
        return ThyroidException.__name__str()